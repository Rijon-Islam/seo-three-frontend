            ...
            <div className="contact-from">
              ...
              <form action="#" onSubmit={handleMessage}>
                <div className="row">
                  ...
                  <div className="col-12">
                    <button className="btn btn-solid w-100">Send Message</button>
                  </div>
                </div>
              </form>
            </div>
...

              {
                action.map(a => <div className="col-lg-7 col-md-10">
                  <div className="cta-content">
                    ...
                    <a href={a.buttonLink} className="btn btn-solid">{a.buttonText}<i className="far fa-long-arrow-right" /></a>
                  </div>
                </div>)
              }
